...
var Carta = (function () {
	function Carta(color, numero, id) {
	...
	_createClass(Carta, [{
		key: 'CrearCartas',
		value: function CrearCartas(colores) {
			var deck = [];
			for (var x = 0; x < 2; x++) {
				for (var i = 0; i < 10; i++) {
					var _temp = new Carta(colores[0], i, uid());
					deck.push(_temp);
				}
				for (var i = 0; i < 10; i++) {
					var _temp2 = new Carta(colores[1], i, uid());
					deck.push(_temp2);
				}
				for (var i = 0; i < 10; i++) {
					var _temp3 = new Carta(colores[2], i, uid());
					deck.push(_temp3);
				}
				for (var i = 0; i < 10; i++) {
					var _temp4 = new Carta(colores[3], i, uid());
					deck.push(_temp4);
				}
				/*for (var i = 0; i < 4; i++) { 
   ...
   deck.splice(27,1);*/
		...
		key: 'Repartir',
		value: function Repartir(cartas, player1, player2, player3, player4) {

			for (var i = 0; i < cartas.length; i++) {
				//revulve las cartas
				var card = cartas[i];
				var index = Math.floor(Math.random() * cartas.length - 1 + 1);
...
$(function () {
	...
	$('.Carta').on('click', '.Carta-imagen', function () {
		var id = $(this).attr('id');
		var cardPlay = $.grep(player1, function (e) {
			return e.id === id;
		});
		var turno = $(".Deck").attr('id');
		console.log(turno);
...
function ia(cartaBuscar, player) {
	...
	for (var i = 0, len = player.length; i < len; i++) {
		if (player[i].color === color) return i;
		if (player[i].numero === numero) return i;
	}
	return null;
}
...
},{"jquery":3,"jquery.transit":2,"uid":4,"velocity-animate":5}],2:[function(require,module,exports){
/*!
